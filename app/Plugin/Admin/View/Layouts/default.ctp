    ...
    <header>
      ...
      <nav class="top-bar" data-topbar>
        ...
        <ul class="title-area">
          ...
          <ul class="right">
            <li <?php if ($page == 'home') echo 'class="active"'; ?>><?php echo $this->Html->link('Announcements', '/'); ?></li>
            <li <?php if ($page == 'about') echo 'class="active"'; ?>><?php echo $this->Html->link('Job Postings', '/about'); ?></li>
            <li <?php if ($page == 'quotes') echo 'class="active"'; ?>><?php echo $this->Html->link('Sign Out', '/login'); ?></li>
          </ul>
        </div>
        </div>
      </nav>
